...
<template>
    <div class="p-2">
        ...
        <ul class="nav flex-column mb-auto">
            <li>
                <RouterLink to="/" exact-active-class="nav-active" class="nav-link my-1">
            ...
            <li>
                <RouterLink to="/categories" exact-active-class="nav-active" class="nav-link my-1">
            ...
            <li>
                <RouterLink to="/transactions" exact-active-class="nav-active" class="nav-link my-1">
            ...
            <li>
                <RouterLink to="/reports" exact-active-class="nav-active" class="nav-link my-1">
