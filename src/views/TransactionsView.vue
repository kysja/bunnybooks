<script setup>
    ...
    const amountColor = reactive({'Expense':'red', 'Income':'green', 'COGS':'purple' })
    ...
    <table class="table table-bordered  my-5">
        <tbody>
            <tr v-for="transaction in transactions" :key="transaction.id">
                ...
                <td class="text-center"><span :style="{color:amountColor[transaction.category_type]}">${{ transaction.amount.toLocaleString() }}</span></td>
